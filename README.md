# GreenStack.Umbraco.CleanStarterKit-v13

A GitHub template repository for Umbraco 13 (LTS) with the [Clean Starter Kit](https://marketplace.umbraco.com/package/clean) by prjseal, preconfigured for [GreenStack](https://umbhost.net/sustainable-cloud-hosting/modern-umbraco-hosting) hosting.

## What's included

- Umbraco 13 (LTS) on .NET 8
- [Clean Starter Kit](https://marketplace.umbraco.com/package/clean) by prjseal
